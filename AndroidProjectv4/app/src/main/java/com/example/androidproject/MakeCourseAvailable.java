...
public class MakeCourseAvailable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStartDate.setBackgroundColor(darkGreen);
        mRegistrationDeadline.setBackgroundColor(darkGreen);
        makeAvailableButton.setBackgroundColor(darkGreen);
    ...
    private void makeCourseAvailable(Course course) {
        ...
        if (! db.isScheduleAvailableForInstructor(instructorEmail,schedule)) {
            Toast.makeText(this, "Error: Instructor gives another course with the same schedule ", Toast.LENGTH_SHORT).show();
            return;
        }
