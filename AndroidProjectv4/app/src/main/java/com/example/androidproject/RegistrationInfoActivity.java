...
public class RegistrationInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> studentAdapter = new ArrayAdapter<>(this, R.layout.custom_list_item_1, studentNames);
        listView.setAdapter(studentAdapter);

        listView.setOnItemClickListener((parent, view, position, id) -> {
            Student student = registeredStudents.get(position);
            Intent intent = new Intent(RegistrationInfoActivity.this, StudentInfoActivity.class);
