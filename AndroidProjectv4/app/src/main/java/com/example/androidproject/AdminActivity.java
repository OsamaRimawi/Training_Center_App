        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.nav_cources:
                    editIntent = new Intent(AdminActivity.this, ApplicationsActivity.class);
                    editIntent.putExtra("email", email);
                    editIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(editIntent);
                    break;
                case R.id.nav_profiles:
                    editIntent = new Intent(AdminActivity.this, ManageUsersActivity.class);
                    editIntent.putExtra("email", email);
                    editIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(editIntent);
                    break;
                case R.id.nav_settings:
                    editIntent = new Intent(AdminActivity.this, MainActivity.class);
                    editIntent.putExtra("email", email);
                    editIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(editIntent);
                    break;
